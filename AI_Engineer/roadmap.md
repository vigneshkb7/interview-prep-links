...
Very common
2
Build a streaming chat endpoint in Node/Python
SSE or WebSocket, backpressure, client reconnect, token counting
Common
3
Design a semantic cache for LLM responses
...
Very common
5
Evaluation harness for an LLM feature
...
Very common
2
Design an AI coding assistant (like Cursor/Copilot)
...
Staff level
4
Design LLM serving infrastructure for 100k RPM
